...
def lambda_handler(event, context):
    ...
    commentPromptMapBySubjectName ={
       ...
       "DEBATE":{
          ...
          - The overall comment should be one paragraph, without bullet points, no longer than 12 sentences, and should start with a compliment. The general aim should be to encourage the student while providing specific, actionable advice for improvement. Do not use too many “but”s as it may discourage the student. Provide examples for improvement if necessary.
          ''',
          "O2":'''
          ...
          - The overall comment should be one paragraph, without bullet points, no longer than 13 sentences, and should start with a compliment. The general aim should be to encourage the student while providing specific, actionable advice for improvement. Do not use too many “but”s as it may discourage the student. Provide examples for improvement if necessary.          
          ''',
          "O3":'''
          ...
          - The overall comment should be one paragraph, without bullet points, no longer than 15 sentences, and should start with a compliment. The general aim should be to encourage the student while providing specific, actionable advice for improvement. Do not use too many “but”s as it may discourage the student. Provide examples for improvement if necessary.                  
          ''',
       },
       "WRITING":f'''
